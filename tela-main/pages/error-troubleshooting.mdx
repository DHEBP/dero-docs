...
**Cause:** The `id` field must be exactly 64 hexadecimal characters (representing a 32-byte hash).
...
console.log(appId);  // "a1b2c3d4e5f6..." (64 hex chars)
console.log(appId.length);  // 64
```
...
- [XSWD Connection Pattern](/demo/xswd-connection) - Verified connection code that avoids common errors
