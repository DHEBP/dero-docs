...
<Cards>
  <Card 
    ...
    title="XSWD Advanced (Official)" 
    href="/templates/xswd-advanced"
  >
    Production-grade XSWD library with comprehensive API coverage (25KB, requires compression)
  </Card>
  <Card 
    icon={<div className="text-2xl">🔋</div>} 
    title="XSWD Basic Core" 
    href="/templates/xswd-basic"
  >
  ...
  <Card 
    icon={<div className="text-2xl">📦</div>} 
    title="TELA API Template (Downloadable)" 
    href="/examples/templates/tela-api-template.js"
  >
    Complete JavaScript library with all DERO/TELA RPC methods (~17KB, pure JS, no dependencies)
  </Card>
</Cards>
...
<Callout type="info" emoji="📥">
  **Direct Download**: [tela-api-template.js](/examples/templates/tela-api-template.js) - Complete DERO/TELA API implementation you can include in any TELA application. Right-click and save, or copy the code directly.
</Callout>
...
✅ **XSWD Advanced integration** for robust wallet connectivity  
...
- **[XSWD Advanced](/templates/xswd-advanced)** - Full-featured, production-ready (recommended)
- **[XSWD Basic Core](/templates/xswd-basic)** - Lightweight for size-constrained apps
...
2. **[Learn Best Practices](/best-practices)** - Production development guide  
3. **[Customize Design](/design-reference)** - Use design system components
...
- [XSWD Advanced](/templates/xswd-advanced) - Official XSWD library
- [XSWD Basic Core](/templates/xswd-basic) - Lightweight XSWD
- [TELA API Template (Download)](/examples/templates/tela-api-template.js) - Complete API library

**Development Resources:**
- [First App Tutorial](/tutorials/first-app) - From zero to deployed app
- [API Reference](/api-reference/complete-api-guide) - Complete API documentation
- [JavaScript Guidelines](/javascript-guidelines) - Proven code patterns

**Deployment:**
- [TELA CLI Workflows](/tela-cli/workflows) - Production deployment
- [XSWD Protocol](/xswd/overview) - Wallet integration
- [Size Optimization](/best-practices#size-optimization-techniques) - File optimization
