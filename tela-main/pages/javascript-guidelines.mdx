...
XSWD connection patterns, application data structures, and API integration are fully documented in the [XSWD Protocol](/xswd) reference and [TELA Demo](/demo) section with complete working code.
...
**Key Takeaway:** All XSWD patterns work perfectly in TELA. The protocol reference has the exact code patterns to copy.
...
- [XSWD Protocol](/xswd) - Connection and protocol reference
- [API Call Patterns](/demo/api-patterns) - RPC method examples
