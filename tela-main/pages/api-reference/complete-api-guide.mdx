...
<Callout emoji="💡">
  **Quick Reference**: Download the [TELA API Template](/examples/templates/tela-api-template.js) - a complete JavaScript implementation with all DERO/TELA methods included (~17KB, ready to use).
</Callout>
...
**Endpoint**: `ws://localhost:44326/xswd` (matches app1 demo pattern)
...
- **[XSWD Connection Guide](/xswd)** - Deep dive into wallet integration
- **[Design Reference](/design-reference)** - UI components and styling
- **[Best Practices](/best-practices)** - Deployment requirements and optimization
- **[Libraries Overview](/advanced-features/libraries-overview)** - Reusable code components

---

*This API guide covers all major DERO and TELA functionality. For the latest updates and additional methods, refer to the [official DERO documentation](https://docs.derofoundation.org/developer/RPC.html) and community resources.*
