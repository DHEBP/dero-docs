...
1. **[Advanced Features](/advanced-features)** - DocShards, compression, and libraries
...
<Callout type="info" emoji="🎓">
  **Learning Path**: Start with this tutorial, then explore the [Best Practices](/best-practices), [Complete API Guide](/api-reference/complete-api-guide), and finally dive into [Advanced Features](/advanced-features) when you're ready to build more complex applications.
</Callout>
