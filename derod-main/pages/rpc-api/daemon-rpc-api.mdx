...
| Name   | Type    | Mandatory | Comment       |
|--------|---------|-----------|---------------|
| topo_height   | uint64    | true     | Block Topological Height    |
...
| Name   | Type    | Mandatory | Comment       |
|--------|---------|-----------|---------------|
| tx_hashes   | []Hash    | true     | TXs Hashes    |
...
| topheight | int64  | false     | data at specified height  |
| keysuint64 | []unint64  | false     | All variables with these int keys  |
