...
For detailed development instructions, see the [TELA Development Guide](https://tela.derod.org/tela-development-guide) and [TELA Documentation](https://tela.derod.org).
