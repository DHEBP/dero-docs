...
graph TB
    ...
    S --> S1["Anonymity-set proof: 1 sender hidden among 8 (ring size 16, 8+8 parity split)"]
...
**Technical:**
- [DERO Wallets](/basics/wallets) - Account and address generation
- [Stealth Addresses](/privacy/stealth-addresses) - Why DERO has none, and what it uses instead
