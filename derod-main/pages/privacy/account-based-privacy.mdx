...
**DERO's Flow:** Submit to Sigma-block (~1 sec) → Account update → Main block (~18 sec) = **~18 seconds total**

| Aspect | DERO Account Model |
|--------|-------------------|
| **Confirmation** | ~18 seconds |
...
| **4. Main Block** | ~18s | Aggregated and confirmed |
| **5. Final** | ~18s | Transaction final |
...
|---------|---------|--------|
| **⚡ Instant Transactions** | ~18 second confirmation | Fast finality |
