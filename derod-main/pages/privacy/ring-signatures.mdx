...
graph TB
    ...
    BC --> P[Privacy: Alice hidden<br/>among N members]
```
...
**Ring signature:**
```
[Alice + N-1 others] sign → ONE of N sent it, which one? Unknown ✅
```
...
|-----------|---------------|----------------|-------------------------|
| 2 | Minimal | 1553 | 1 in 2 |
| 4 | Low | 2013 | 1 in 4 |
| 8 | Medium | 2605 | 1 in 8 |
| 16 | Good | 3461 | 1 in 16 |
| 32 | Strong | 4825 | 1 in 32 |
| 64 | Very Strong | 7285 | 1 in 64 |
| 128 | Maximum | 11839 | 1 in 128 |
