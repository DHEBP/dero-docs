...
|------------|-----------------|-------------|------------|
| **Ring Signatures** | Sender identity | Hide among 2-128 members (naive guess 1/N) | [Explore →](/privacy/ring-signatures) |
...
**Hide among 2-128 members.**

Your address is mixed with other members in a ring. The blockchain sees ONE of them sent the transaction, but cannot determine which one.

**Privacy Levels (naive guess):**
- 1 in N chance if no additional information is available
