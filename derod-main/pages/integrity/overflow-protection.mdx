...
|-------|-----------------|----------|
| **Overflow check** | Arithmetic manipulation (fee wraparound) | `proof_verify.go:108-110` |
| **Bulletproof range proof** | Out-of-range values, including negative/wraparound amounts | `proof_verify.go` (every node) |
| **Inner product verification** | Proof forgery / cryptographic consistency | `proof_innerproduct.go` |
