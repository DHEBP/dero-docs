...
**Location:** `proof_verify.go:177-179`

```go
// Verify we can recover B^w * A from the proof components
...
if stored.String() != computed.String() {
  ...
  <Tabs.Tab>
    **A_t: Range Proof**
    ...
    func VerifyAt(A_t, proof, c) bool {
        ...
        // Check: combined 128-bit value is valid (transfer + balance)
