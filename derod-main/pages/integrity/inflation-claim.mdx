...
|----------|--------------|
| **Did total supply increase by ~2.2M DERO?** | **Not by the alleged mechanism.** Exploit-block reward was **0.615 DERO**, not 2.2M; the cited TX was accepted under range proofs. No supply delta published. [Part 4](#verify-supply-at-the-exploit-block) |
