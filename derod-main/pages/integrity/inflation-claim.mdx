...
<Callout type="info" emoji="🤖">
This tier goes live with the **v0.4.0** release — the hosted endpoint at `mcp.derod.org` plus the npm package (forge tool + local-first resolution). Until then, install from [source](https://github.com/DHEBP/dero-mcp-server).
</Callout>
