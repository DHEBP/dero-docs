...
| **A_t** | Amount is in range [0, 2^64] | Prevents negative/overflow |
...
**Purpose:** Proves amount is in valid range [0, 2^64] without revealing the amount.

**This is the bulletproof component:**
- Uses bit decomposition
- Logarithmic proof size (~2KB)
- Prevents negative amounts
- Prevents overflow amounts

**[Detailed explanation →](/integrity/range-proof-integrity)**

**Source:** `cryptography/crypto/proof_generate.go:473-487` - Bit decomposition
