...
| **Double spending** | A_u proof + consensus | Discrete log assumption + consensus rules |
...
<Callout type="info" emoji="📐">
**Mathematical Foundation:** DERO's security relies on the elliptic curve discrete logarithm problem on its chosen curve parameters. Breaking DERO's security would require a breakthrough on those assumptions.
</Callout>
