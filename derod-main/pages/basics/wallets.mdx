...
The CLI wallet, the fundamental and official wallet, ships with the DERO daemon source at [DEROFDN/derohe](https://github.com/DEROFDN/derohe) (see [Contributing](/contributing)). Offering all necessary functions, starting with this wallet is recommended.
...
- Mac (Intel): `./dero-wallet-cli-darwin-amd64`
- Mac (Apple Silicon): `./dero-wallet-cli-darwin-arm64`
...
**Learn More:**
- [Engram Introduction](/engram) - What is Engram?
- [Engram Features](/engram/features) - Full feature list
- [User Guide](/engram/user-guide) - Getting started
- [Wallet Integration](/engram/wallet-integration) - Build for Engram
