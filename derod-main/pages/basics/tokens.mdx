...
Captain summarized the same model in chat — native assets, wallet-custodied, contract-independent:
...
The SC defines what an asset *is* (its SCID is the asset's identity); it does not custody the balances.
