...
Miniblocks carry timestamps. If your node's clock drifts more than a few hundred milliseconds from network median, the network rejects your work (shows up as `MBR` climbing — see [Reading the derod prompt → MB / MBR / IB counters](/basics/daemon#mb--mbr--ib-counters)). Captain's recommendation is **chrony**, not the default `ntpd`:
...
<CaptainNote
  ...
  channel="#dero-mining"
>
  Add in /etc/chrony.conf or /etc/chrony/chrony.conf following: `server time.google.com iburst prefer` / `server time.cloudflare.com iburst prefer`
</CaptainNote>
...
<CaptainNote
  source="https://discord.com/channels/419781880632836096/557277155436789760/1042706857195733024"
  date="2022-11-17"
  channel="#suggestions"
>
  Run your own node and mine on it. Single node supports more than 10000 miners easily.
</CaptainNote>

<CaptainNote
  source="https://discord.com/channels/419781880632836096/427613001537814540/1092655070623039498"
  date="2023-04-04"
  channel="#dero-mining"
>
  Also there are several tests conducted above, Solo mining has same or better rewards than pool.
</CaptainNote>
