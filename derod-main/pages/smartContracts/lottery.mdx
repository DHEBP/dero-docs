...
5. Dero testnet Explorer:
   ```bash
   ./explorer-linux-amd64 --rpc-server-address 127.0.0.1:40402 --http-address=0.0.0.0:8080
   ```

   - [Dero Stargate Testnet Explorer](https://testnetexplorer.derofoundation.org/)
