...
keywords: ["DERO asset exchange", "token swap", "smart contract exchange", "cryptocurrency exchange", "DVM-BASIC", "blockchain trading", "token interchange", "DERO tokens", "decentralized exchange", "private token exchange"]
date: "2024-08-26"
lastUpdated: "2025-10-19"
authors: ["DHEBP"]
image: "/assets/asset-exchange.jpeg"
slug: "assets"
canonicalUrl: "https://derod.org/smartContracts/assets"
tags: ["smart-contracts", "assets", "exchange", "DVM-BASIC", "DEX"]
---
...
5. **Swap assetOne for assetTwo** via the exchange contract:
    ```bash
    curl --silent http://127.0.0.1:40403/json_rpc -d '{
        "jsonrpc":"2.0",
        "id":"0",
...
- [DERO Tokens Overview](/basics/tokens) - How private tokens work
- [Homomorphic Encryption](/privacy/homomorphic-encryption) - Encrypted balances explained
- [Private Smart Contracts](/privacy/private-smart-contracts) - Privacy features

**Learn the Language:**
- [DVM-BASIC Programming Guide](/dvm/dvm-basic) - Smart contract syntax
- [DERO Virtual Machine](/dvm/dero-virtual-machine) - VM architecture

**More Examples:**
- [Token Contract](/smartContracts/token) - Basic private token
- [Lottery Contract](/smartContracts/lottery) - Randomized winner selection
- [Name Service](/smartContracts/name) - Username registration

**Deploy:**
- [Wallet RPC API](/rpc-api/wallet-rpc-api) - Install and interact with contracts