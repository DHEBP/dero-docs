...
<Callout type="success">
  **New in v6.3** - Expose Gnomon's indexing data via WebSocket for external applications and TELA dApps.
</Callout>
...
| **Testnet** | 40402 | Testing |
| **Simulator** | 20000 | Development |

```go
SetNetworkMode(mode string) -> { success: true }
// mode: "mainnet", "testnet", "simulator"
```

<Callout type="info">
  Wallet files are network-specific. Opening a mainnet wallet while on testnet will show a warning.
</Callout>
