...
See [telaHost API Reference](/telahost-api) for full documentation, including [Session 101 Permission Scoping](/telahost-api#smart-permission-detection-session-101).
