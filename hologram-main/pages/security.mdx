...
<Callout type="info">
  Hologram auto-detects read-only apps and shows a "Read-Only Access" badge instead of wallet permissions. Learn more in [Session 101 Permission Scoping](/telahost-api#smart-permission-detection-session-101).
</Callout>
...
2. **Don't specify permissions** — Let Hologram auto-detect (Session 101)
