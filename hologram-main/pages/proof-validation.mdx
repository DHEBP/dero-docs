...
const (
    ...
    // Setting max at 22M DERO = ~5% above hard cap for buffer
    // while blocking impossible amounts
...
for i, amt := range amounts {
    // Validate each amount (blocks impossible amounts, collects warnings + context)
    ...
    // Collect warnings and supply context for suspicious but valid amounts
