...
|--------|-------------|----------|
| **Embedded Node** | Run derod inside Hologram | Maximum sovereignty |
| **Remote Node** | Connect to public node | Quick start |
| **Custom Node** | Your own derod instance | Advanced users |
| **Simulator** | Local development mode | Developers |

<Callout type="info">
  You can skip the wizard and configure everything later from Settings. The wizard is just a convenient starting point.
</Callout>
...
- [Mining Guide](/mining) - Optimize your mining setup
