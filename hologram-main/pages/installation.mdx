...
<Callout type="warning">
  **Pre-built binaries are rolling out gradually.** If a binary for your platform isn't listed on the [Releases page](https://github.com/DHEBP/HOLOGRAM/releases) yet, see [Building from Source](#building-from-source) below.
</Callout>

As binaries become available, download the latest release from the [GitHub Releases](https://github.com/DHEBP/HOLOGRAM/releases) page.
