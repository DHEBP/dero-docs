...
GetBalanceAtHeight(address string, topoheight int64, scid string) map[string]interface{}
...
RateTELA(scid string, rating uint64) map[string]interface{}
...
BuildRating(category int, detail int) map[string]interface{}
SubmitRatingWithPicker(scid string, category int, detail int) map[string]interface{}
```
...
SetContentFilterConfig(enabled bool, minRating int, blockMalware bool, blockUnrated bool, requireEpoch bool, showWarnings bool, parentalLevel string, epochBonus int) map[string]interface{}
...
CheckAppFilter(scid string, name string, author string, category string, rating int, ratingCount int, supportsEpoch bool) map[string]interface{}
