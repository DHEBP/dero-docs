...
You are an AI assistant interacting with [pay.derod.org](https://pay.derod.org). This document is the canonical agent-facing operating runbook. It is companion to [llms.txt](https://pay.derod.org/llms.txt) (curated link list) and [SKILL.md](https://pay.derod.org/SKILL.md) (per-tool reference for the DERO MCP server).
...
1. **Prerequisites — wallet + environment** — [`/guides/prerequisites.md`](https://pay.derod.org/guides/prerequisites.md)
2. **DeroPay Quick Start — accept payments** — [`/dero-pay/quick-start.md`](https://pay.derod.org/dero-pay/quick-start.md)
3. **Add DeroAuth wallet login** — [`/dero-auth/quick-start.md`](https://pay.derod.org/dero-auth/quick-start.md)
4. **Wire up webhooks for confirmations** — [`/dero-pay/webhooks.md`](https://pay.derod.org/dero-pay/webhooks.md)
5. **Decide: Escrow vs Payment Router** — [`/payment-router/escrow-vs-router.md`](https://pay.derod.org/payment-router/escrow-vs-router.md)
6. **(Optional) Add x402 for agent APIs** — [`/dero-pay/x402.md`](https://pay.derod.org/dero-pay/x402.md)
...
Full per-tool guidance: [SKILL.md](https://pay.derod.org/SKILL.md).
